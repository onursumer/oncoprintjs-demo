...
import {hm_data} from "./heatmap-data";

export function heatmap() {
    var oncoprint = new OncoprintJS('#oncoprint-heatmap', 800);
    var TRACK_GROUP = 1;
